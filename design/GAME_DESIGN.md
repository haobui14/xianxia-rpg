...
| **M2 — Living world & storyteller** (4–6 wks) | NPC interactions, relations and karma ledger; `/api/story` dialogue + chronicle + rumors; sect joining and missions on the map *(built: the mission hall with self-tracking missions, merit and ranks, stipends, the treasury and the spirit-gathering chamber)*; bounty board; auction | NPC stories emerge unprompted in a 3-hour run |
