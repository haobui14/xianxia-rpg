...
export default function EnemyPortrait({
  ...
  return (
    ...
    >
      {/* Hit flash overlay */}
      {hitFlash && <div className="absolute inset-0 bg-red-500/30 rounded-lg animate-pulse" />}
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex-1">
          {/* Enemy name */}
          <h3
            className={`text-lg font-bold text-xianxia-accent ${deathAnimation ? "line-through" : ""}`}
          >
