...
const THANH_VAN_AREAS: Area[] = [
  {
    ...
    description_en:
      "A peaceful village at the foot of the mountains, where many cultivators begin their journey.",
    available_actions: [
      COMMON_ACTIONS.rest,
      COMMON_ACTIONS.travel_area,
      COMMON_ACTIONS.travel_region,
    ],
    enemy_pool: [],
  ...
  },
  {
    ...
    available_actions: [COMMON_ACTIONS.explore, COMMON_ACTIONS.hunt, COMMON_ACTIONS.travel_area],
...
const THANH_VAN: Region = {
  ...
  name_en: "Azure Cloud",
  description:
    "Vùng đất khởi đầu với rừng xanh tốt và làng mạc yên bình. Nơi lý tưởng cho tu sĩ mới bắt đầu con đường tu tiên.",
  description_en:
    "A starting region with lush forests and peaceful villages. Ideal for new cultivators beginning their immortal path.",
  element: "Mộc",
  tier: 1,
...
const HOA_SON_AREAS: Area[] = [
  {
    ...
    description_en:
      "A city built around the entrance to the volcano, gathering place for fire cultivators.",
    available_actions: [
      COMMON_ACTIONS.rest,
      COMMON_ACTIONS.travel_area,
      COMMON_ACTIONS.travel_region,
...
const HOA_SON: Region = {
  ...
  description:
    "Dãy núi lửa khổng lồ với nhiệt độ cực cao. Nơi đây có nhiều nguyên liệu hỏa hệ quý hiếm và bí kíp luyện hỏa.",
  description_en:
    "A massive volcanic mountain range with extreme temperatures. Contains rare fire materials and flame cultivation techniques.",
  element: "Hỏa",
  tier: 2,
...
const HUYEN_THUY: Region = {
  ...
  description:
    "Vùng biển huyền bí với những hòn đảo và vực sâu. Nơi ẩn chứa nhiều bí mật của long tộc và các sinh vật biển.",
  description_en:
    "Mysterious waters with islands and deep trenches. Hides many secrets of the dragon race and sea creatures.",
  element: "Thủy",
  tier: 3,
...
const TRAM_LOI_AREAS: Area[] = [
  {
    ...
    description_en:
      "An ancient citadel built with conductive metals, where thunder cultivators train.",
    available_actions: [
      COMMON_ACTIONS.rest,
      COMMON_ACTIONS.travel_area,
      COMMON_ACTIONS.travel_region,
  ...
  },
  {
    ...
    description_en:
      "A valley where lightning strikes constantly, considered a tribulation testing ground.",
    available_actions: [
      COMMON_ACTIONS.explore,
      COMMON_ACTIONS.cultivate,
      COMMON_ACTIONS.hunt,
  ...
  },
  {
    ...
    description_en:
      "An abandoned ancient observatory containing knowledge of cultivators from ages past.",
    available_actions: [COMMON_ACTIONS.explore, COMMON_ACTIONS.hunt, COMMON_ACTIONS.travel_area],
...
const TRAM_LOI: Region = {
  ...
  description:
    "Vùng đất với bão điện vĩnh cửu và di tích cổ đại. Nơi thử thách thiên kiếp và chứa nhiều kỹ thuật lôi điện.",
  description_en:
    "A land of eternal electrical storms and ancient ruins. A place of heavenly tribulation trials and thunder techniques.",
  element: "Kim",
  tier: 4,
...
const VONG_LINH: Region = {
  ...
  description:
    "Vùng đất của linh hồn và hư vô, nơi cao thủ thời cổ an nghỉ. Chứa đựng di sản mạnh nhất nhưng cũng nguy hiểm nhất.",
  description_en:
    "Land of spirits and void, where ancient masters rest. Contains the most powerful legacies but also the greatest dangers.",
  element: "Thổ",
  tier: 5,
