...
const EXPLORATION_EVENTS: RandomEvent[] = [
  // COMMON EVENTS
  {
    ...
    narrative_en:
      "While exploring, you discover a patch of wild medicinal herbs growing abundantly.",
    choices: [
      {
        id: "gather_all",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "stats.stamina", operation: "subtract", value: 5 }],
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "karma", operation: "add", value: 5 }],
            items: ["spirit_herb"],
          },
        ],
        outcome_weights: [1],
  ...
  },
  {
    ...
    weight: 15,
    narrative:
      "Ngươi tìm thấy một hang động nhỏ với dấu vết của tu sĩ đã rời đi từ lâu. Bên trong có một chiếc rương cũ.",
    narrative_en:
      "You find a small cave with traces of a cultivator long gone. Inside is an old chest.",
    choices: [
      {
        id: "open_chest",
        text: "Mở rương",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "inventory.silver", operation: "add", value: 100 }],
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "karma", operation: "subtract", value: 5 }],
          },
        ],
        outcome_weights: [1],
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ field: "karma", operation: "subtract", value: 15 }],
  ...
  },
  {
    ...
    weight: 5,
    narrative:
      "Ngươi phát hiện một trận pháp cổ đại khắc trên đá. Nó dường như đang bảo vệ điều gì đó.",
    narrative_en:
      "You discover an ancient formation carved into stone. It seems to be protecting something.",
    choices: [
      {
        id: "study",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 50 }],
      ...
      },
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ field: "stats.hp", operation: "subtract", value: 50 }],
          },
        ],
  ...
  },
  {
    ...
    narrative:
      "Một tia sáng dẫn ngươi đến một hang động bí mật. Bên trong, linh hồn của một đại năng cổ đại đang chờ đợi người kế thừa.",
    narrative_en:
      "A beam of light leads you to a secret cave. Inside, the spirit of an ancient master awaits an inheritor.",
    choices: [
      {
        id: "accept",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 200 }],
          ...
          },
          {
            ...
            effects: [{ field: "stats.hp", operation: "subtract", value: 20 }],
          },
        ],
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 30 }],
          },
        ],
        outcome_weights: [1],
      },
...
const TRAVEL_EVENTS: RandomEvent[] = [
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "inventory.silver", operation: "subtract", value: 50 }],
          },
        ],
        outcome_weights: [1],
      },
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "reputation", operation: "add", value: 5 }],
          },
        ],
        outcome_weights: [1],
      },
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "stats.stamina", operation: "subtract", value: 20 }],
          },
          {
            id: "lightning",
    ...
    choices: [
      {
        ...
        outcomes: [
          ...
          },
          {
            ...
            effects: [{ field: "stats.hp", operation: "subtract", value: 25 }],
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 20 }],
          },
        ],
        outcome_weights: [1],
      },
  ...
  },
  {
    ...
    weight: 1,
    narrative:
      "Bầu trời bất ngờ sáng rực với ánh sáng ngũ sắc! Một thiên tượng hiếm có đang diễn ra!",
    narrative_en:
      "The sky suddenly lights up with five-colored light! A rare celestial phenomenon is occurring!",
    choices: [
      {
        id: "cultivate",
...
const CULTIVATION_EVENTS: RandomEvent[] = [
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "subtract", value: 10 }],
          },
        ],
        outcome_weights: [1],
      },
  ...
  },
  {
    ...
    narrative_en:
      "You feel an invisible wall before you! This might be a breakthrough opportunity!",
    choices: [
      {
        id: "attempt",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 80 }],
          },
          {
            id: "failure",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 15 }],
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "stats.stamina", operation: "subtract", value: 10 }],
          },
        ],
        outcome_weights: [1],
      },
  ...
  },
  {
    ...
    narrative_en:
      "A flash of light in your consciousness! You begin to comprehend the dao of heaven and earth!",
    choices: [
      {
        id: "embrace",
        ...
        outcomes: [
          {
            ...
            effects: [{ field: "progress.cultivation_exp", operation: "add", value: 25 }],
          },
          {
            id: "enemy",
...
export function getEventsForRegion(regionId: string, trigger: string): RandomEvent[] {
  ...
  return events.filter((event) => !event.regions || event.regions.includes(regionId as any));
}
