...
const SPIRIT_HERB_REALM_FLOORS: DungeonFloor[] = [
  {
    ...
    description: 'Vườn ngoài với các loại thảo dược thường thấy, được bảo vệ bởi côn trùng khổng lồ.',
    description_en: 'Outer garden with common herbs, guarded by giant insects.',
    enemy_waves: [
      { id: 'wave_1_1', enemies: ['spirit_bee', 'spirit_bee'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_2_1', enemies: ['herb_guardian', 'spirit_bee'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_3_1', enemies: ['tree_spirit', 'tree_spirit', 'herb_guardian'], spawn_chance: 1 },
    ],
...
const SPIRIT_HERB_REALM: Dungeon = {
  ...
  description: 'Một bí cảnh được tạo ra bởi đại năng thời xưa để nuôi trồng linh thảo. Nay đã hoang phế và bị tinh linh cây chiếm giữ.',
  description_en: 'A secret realm created by an ancient master to cultivate spirit herbs. Now abandoned and occupied by tree spirits.',
  type: 'secret_realm',
  region: 'thanh_van',
...
const PHOENIX_TOMB_FLOORS: DungeonFloor[] = [
  {
    ...
    enemy_waves: [
      { id: 'wave_1_1', enemies: ['fire_lizard', 'fire_lizard'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      ...
      { id: 'wave_2_2', enemies: ['lava_slug', 'lava_slug', 'lava_slug'], spawn_chance: 0.8 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_3_1', enemies: ['flame_hawk', 'flame_hawk'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_4_1', enemies: ['fire_elemental', 'flame_hawk', 'magma_golem'], spawn_chance: 1 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_5_1', enemies: ['phoenix_remnant', 'fire_elemental', 'fire_elemental'], spawn_chance: 1 },
    ],
...
const PHOENIX_TOMB: Dungeon = {
  ...
  description: 'Lăng mộ của Phượng Hoàng Tổ Sư, một đại năng hỏa hệ thời cổ đại. Nơi đây chứa đựng những bí kíp hỏa công và bảo vật phượng hoàng.',
  description_en: 'Tomb of the Phoenix Patriarch, an ancient fire cultivation master. Contains fire techniques and phoenix treasures.',
  type: 'ancient_tomb',
  region: 'hoa_son',
  area: 'phoenix_peak',
  tier: 2,
...
const DRAGON_TURTLE_FLOORS: DungeonFloor[] = [
  {
    ...
    enemy_waves: [
      { id: 'wave_1_1', enemies: ['giant_crab', 'giant_crab'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      ...
      { id: 'wave_2_2', enemies: ['water_elemental', 'coral_golem'], spawn_chance: 0.7 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      ...
      { id: 'wave_3_2', enemies: ['abyssal_fish', 'abyssal_fish', 'abyssal_fish'], spawn_chance: 0.8 },
    ],
    chest_count: 2,
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_4_1', enemies: ['turtle_warrior', 'turtle_warrior'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_5_1', enemies: ['turtle_warrior', 'sea_drake', 'water_elemental'], spawn_chance: 1 },
    ],
...
const DRAGON_TURTLE_LAIR: Dungeon = {
  ...
  description: 'Hang động dưới nước của Long Quy Cổ Thú, một sinh vật mang huyết mạch long tộc. Cần có vật phẩm hô hấp dưới nước.',
  description_en: 'Underwater cave of the Ancient Dragon Turtle, a creature with dragon bloodline. Water breathing items needed.',
  type: 'beast_lair',
  region: 'huyen_thuy',
...
const TRIBULATION_GROUNDS_FLOORS: DungeonFloor[] = [
  {
    ...
    enemy_waves: [
      { id: 'wave_1_1', enemies: ['static_golem', 'static_golem'], spawn_chance: 1 },
    ],
    chest_count: 2,
  ...
  },
  {
    ...
    enemy_waves: [
      ...
      { id: 'wave_2_2', enemies: ['lightning_hawk', 'lightning_hawk'], spawn_chance: 0.7 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      ...
      { id: 'wave_3_2', enemies: ['lightning_serpent', 'thunder_beast'], spawn_chance: 0.8 },
    ],
    chest_count: 2,
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_4_1', enemies: ['lightning_serpent', 'storm_elemental'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_5_1', enemies: ['ancient_construct', 'ancient_construct'], spawn_chance: 1 },
    ],
    chest_count: 3,
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_6_1', enemies: ['tribulation_beast', 'thunder_elemental', 'storm_elemental'], spawn_chance: 1 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_7_1', enemies: ['tribulation_avatar_fragment', 'thunder_elemental', 'lightning_serpent'], spawn_chance: 1 },
    ],
...
const TRIBULATION_GROUNDS: Dungeon = {
  ...
  description: 'Vùng thử thách thiên kiếp được tạo ra bởi các đại năng cổ đại. Nơi đây có thể giúp tu sĩ rèn luyện thân thể bằng thiên lôi.',
  description_en: 'Tribulation testing grounds created by ancient masters. Can help cultivators temper their bodies with heavenly lightning.',
  type: 'trial_ground',
  region: 'tram_loi',
...
const VOID_HALL_FLOORS: DungeonFloor[] = [
  {
    ...
    enemy_waves: [
      { id: 'wave_1_1', enemies: ['yin_spirit', 'yin_spirit'], spawn_chance: 1 },
    ],
    chest_count: 2,
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_3_1', enemies: ['void_walker', 'yin_spirit'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_4_1', enemies: ['ancestral_remnant', 'ghost_cultivator'], spawn_chance: 1 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_5_1', enemies: ['void_creature', 'void_creature'], spawn_chance: 1 },
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_6_1', enemies: ['void_emperor_shade', 'ancestral_remnant'], spawn_chance: 1 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_7_1', enemies: ['soul_devourer', 'soul_devourer', 'ghost_cultivator'], spawn_chance: 1 },
    ],
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_8_1', enemies: ['void_creature', 'dimensional_beast', 'void_walker'], spawn_chance: 1 },
    ],
    chest_count: 4,
  ...
  },
  {
    ...
    enemy_waves: [
      { id: 'wave_9_1', enemies: ['void_emperor_shade', 'void_creature', 'dimensional_beast', 'void_walker'], spawn_chance: 1 },
    ],
...
const VOID_ANCESTRAL_HALL: Dungeon = {
  ...
  description: 'Tổ đường của Hư Không Đế Quân, một trong những đại năng mạnh nhất thời thượng cổ. Nơi đây chứa đựng di sản và bí mật của hư không chi đạo.',
  description_en: 'Ancestral hall of the Void Emperor, one of the most powerful beings of the primordial era. Contains legacies and secrets of the void dao.',
  type: 'ancient_tomb',
  region: 'vong_linh',
  area: 'void_nexus',
  tier: 5,
...
export function canEnterDungeon(
  ...
  if (dungeon.entry_requirements?.items) {
    for (const item of dungeon.entry_requirements.items) {
      if (!playerItems.includes(item)) {
        return {
          canEnter: false,
          reason: `Thiếu vật phẩm: ${item}`,
          reason_en: `Missing item: ${item}`,
        };
      }
    }
  }
  ...
  if (dungeon.entry_cost) {
    ...
    if (dungeon.entry_cost.item && !playerItems.includes(dungeon.entry_cost.item)) {
      return {
        canEnter: false,
        reason: `Cần vật phẩm: ${dungeon.entry_cost.item}`,
        reason_en: `Requires item: ${dungeon.entry_cost.item}`,
      };
    }
  }
